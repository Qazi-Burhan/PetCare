export function PawIcon({ size = 20, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
...
export function PetsIcon({ size = 20, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      <path d="M6 20v-1.5C6 16.57 8.69 15 12 15s6 1.57 6 3.5V20" />
      <path d="M4 12h2M18 12h2M12 4V2" />
    </svg>
  )
}

export function TasksIcon({ size = 20, className = '' }) {
  return (
    <svg
      width={size}
      height={size}
